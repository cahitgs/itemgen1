...
const RULE_OPTIONS: Array<{ value: RuleKind; label: string }> = [
  ...
  { value: 'and', label: 'AND — col0 ∧ col1 = col2 (Sector Pie veya Checkerboard)' },
  { value: 'or', label: 'OR — col0 ∨ col1 = col2 (Sector Pie veya Checkerboard)' },
  { value: 'xor', label: 'XOR — col0 ⊻ col1 = col2 (Sector Pie veya Checkerboard)' },
